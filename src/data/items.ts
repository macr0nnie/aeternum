...
export const RELICS: Relic[] = [
  ...
  },
  {
    ...
    name: 'Shadow Shard',
    rarity: 'uncommon',
    passiveEffect: 'SPD stat counts double for win-probability calculation in shadow rifts',
    triggerCondition: 'gate_type:shadow',
    dropSource: 'D-rank Shadow Rift',
  ...
  },
  {
    ...
    rarity: 'uncommon',
    passiveEffect: '+10% drop chance in lightning-element rifts',
    triggerCondition: 'gate_element:Lightning',
    statBonus: { SPD: 2 },
    dropSource: 'C-rank rifts',
  ...
  },
  {
    ...
    name: 'Void Lens',
    rarity: 'rare',
    passiveEffect: 'Reveals actual reward rarity before rift commit',
    dropSource: 'B-rank Void Rift',
  ...
  },
  {
    ...
    rarity: 'legendary',
    passiveEffect: 'All stats +3 while inside a rift. Removed on defeat.',
...
export const MATERIALS: MaterialItem[] = [
  { id: 'mat_wolf_fang',      name: 'Wolf Fang',        rarity: 'common',   dropSource: 'F-rank Rift (Forest)',   flavor: 'Still sharp.' },
  { id: 'mat_stone_chip',     name: 'Stone Chip',       rarity: 'common',   dropSource: 'F-rank Rift (Ruins)',    flavor: 'Fragment of something ancient.' },
  { id: 'mat_mana_shard',     name: 'Mana Shard',       rarity: 'uncommon', dropSource: 'E-rank rifts',           flavor: 'Crystallised ambient mana.' },
  { id: 'mat_ember_core',     name: 'Ember Core',       rarity: 'uncommon', dropSource: 'D-rank Fire Rift',       flavor: 'Retains heat for weeks.' },
  { id: 'mat_storm_essence',  name: 'Storm Essence',    rarity: 'uncommon', dropSource: 'D-rank Lightning Rift',  flavor: 'Sealed in a vial lest it discharge.' },
  { id: 'mat_void_fragment',  name: 'Void Fragment',    rarity: 'rare',     dropSource: 'C-rank Shadow Rift',     flavor: 'Has no reflection.' },
  { id: 'mat_shadow_silk',    name: 'Shadow Silk',      rarity: 'rare',     dropSource: 'B-rank rifts',           flavor: 'Lighter than air, darker than night.' },
  { id: 'mat_sovereign_dust', name: 'Grandmaster Dust',   rarity: 'legendary',dropSource: 'A/S-rank final bosses',  flavor: 'Remnant of a defeated grandmaster.' },
  { id: 'mat_star_alloy',     name: 'Star Alloy',       rarity: 'legendary',dropSource: 'S-rank Cosmic Rift',     flavor: 'Forged at stellar temperatures.' },
]
...
export const CONSUMABLES: ConsumableItem[] = [
  {
    ...
    description: 'ATK ×1.1 for next rift attempt',
  ...
  },
  {
    ...
    description: 'SPD ×1.15 for next rift attempt',
  ...
  },
  {
    ...
    description: 'Roll one additional loot drop from next rift',
  ...
  },
  {
    ...
    description: 'PER +3 for next rift attempt',
...
export const HIDDEN_TALENTS: HiddenTalent[] = [
  ...
  },
  {
    ...
    passiveEffect: 'Dodge chance +10% in rift combat',
    statBonus: { SPD: 2 },
  ...
  },
  {
    id: 'ht_warlord',
    name: 'Warlord',
    description: 'Clearing five or more rifts has sharpened your tactical mind.',
    ...
    flavor: 'Five rifts. Five lessons. You survived them all.',
  },
  {
    id: 'ht_chosen_path',
    name: 'Chosen Path',
    ...
    passiveEffect: 'Shadow-element rift drops include one guaranteed rare+',
  ...
  },
  {
    ...
    flavor: 'The rift does not see a adventurer. It sees a force of nature.',
  },
]
